...
\033[1;96m    ~~~~~~~~~~~~~~~~~~~     
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║
\033[1;96m    ║✯ Auther : ReKuShE ,              ║    
\033[1;98m    ║✯ github : IRAQ-hacker            ║  
\033[1;96m    ║✯ YouTube : iraqhacker  ║
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;95m                  (~~~~)       |   |~)
\033[1;95m                  /    \       |   | \
\033[1;95m      ~\          \___/)______/^\__|_/
\033[1;95m        `\      //    |  |      | |
\033[1;95m             ~~       (~~~~)    (~~~)
\033[1;95m                     /     =\..'    =_
\033[1;95m                    |__________)________)
"""
jalan("\033[1;93m ~~~~~~~~~~~~~~~~~``~~~~~~~~~~~~~~~~~~~~~~~~")

jalan("\033[1;92m  _ __   __ _ ___ ____ __ _ _ __ ______       ×××× ReKuShE is number one ~_~✔ ") 
jalan("\033[1;97m|  _  \  | ____| | | / /  | | | | /  ___/ | | | | | ____|")
jalan("\033[1;97m| |_| |  | |__   | |/ /   | | | | | |___  | |_| | | |__  ")
jalan("\033[1;92m|  _  /  |  __|  | |\ \   | | | | \___  \ |  _  | |  __|")
jalan("\033[1;92m| | \ \  | |___  | | \ \  | |_| |  ___| | | | | | | |")                                   
jalan("\033[1;92m|_|  \_\ |_____| |_|  \_\ \_____/ /_____/ |_| |_| |_____|")



CorrectUsername = "ReKuShE"
CorrectPassword = "ReKuShE"
loop = 'true'
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:ReKuShE
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('xdg-open https://youtube.com/iraqhacker')
    else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/iraqhacker')
...
def menu():
	...
	try:
		...
		print"\x1b[1;92mHacking is not difficult, you just wait and challenge the impossible"
		keluar()
	os.system("clear")
	print logo
	print "\033[1;36;40m      ╔═════════════════════════════════╗"
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91miraqhacker\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mReKuShE\033[1;95m•◈•══════••◈•"
		try:
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91miraqhacker\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By ReKuShE--•◈•---»" #Dev:ReKuShE
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 ReKuShE.py)↩\033[1;97m....'
